...
public class TransactionDatabaseGenerator {
	...
	public  void generateDatabase(int transactionCount, int maxDistinctItems, int maxItemCountPerTransaction,
		...
		// We create a BufferedWriter to write the database to memory
	...
	public ByteArrayOutputStream generateDatabase(int transactionCount, int maxDistinctItems, int maxItemCountPerTransaction) throws IOException {

...
public class AlgoEFIM {
	 ...
	 */
	public void runAlgorithm(double theta, String inputPath, String outputPath, boolean activateTransactionMerging, int maximumTransactionCount, boolean activateSubtreeUtilityPruning) throws IOException {
		...
		this.minUtil = (long) (theta * dataset.totalUtility);
